...
def try_methods():
    ...
    Then makes the SimpleTurtle move as follows (in the order listed):
      ...
      -- backward  100 units
    """
    bryan = rg.SimpleTurtle()
    bryan.pen = rg.Pen('brown',5)
    bryan.forward(150)
    bryan.left(90)
    bryan.forward(50)
    bryan.backward(100)
...
def try_methods_and_functions():
    ...
    charles.pen = rg.Pen('blue',5)

    charles.backward(150)

    charles.speed = 1

    draw_many_squares(charles,2,100,30)

    charles.speed = 5
    charles.pen.color = 'red'
    draw_many_squares(charles,10,50,15)

    charles.speed = 100
    charles.pen.thickness = 35
    draw_many_squares(charles,8,300,60)

    charles.pen = rg.Pen('black',3)
    charles.backward(200)
    charles.draw_circle(30)
    charles.draw_square(50)

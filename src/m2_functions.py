...
def turtle5():
    ...
    carson = rg.SimpleTurtle()

    nate.pen = rg.Pen('DarkRed',20)
    carson.pen = rg.Pen('DimGrey',10)
    ...
    nate.draw_regular_polygon(5,50)
    carson.draw_regular_polygon(5,50)
